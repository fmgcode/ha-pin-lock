class PinLockCard extends HTMLElement {
  ...
  static getStubConfig() {
    return { entry_id: "", name: "Garaje", icon: "mdi:garage", pin_length: 4 };
  }
  ...
  _render() {
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        .icon-box { width:38px; height:38px; border-radius:10px; background: rgba(0,0,0,0.06); display:flex; align-items:center; justify-content:center; }
      ...
      <ha-card>
        <div class="head">
          <div class="icon-box"><ha-icon icon="${c.icon}"></ha-icon></div>
          <div>
